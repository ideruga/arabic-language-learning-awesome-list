...
\begin{enumerate}
\item \textarabic{لَا ـــــــ فِي الْبَيْتِ} (no man) [\underline{رَجُلَ}]
\item \textarabic{لَا ـــــــ لَهُ} (no friend) [\underline{صَدِيقَ}]
\item \textarabic{لَا ـــــــ مِنْ هَذَا} (no benefit) [\underline{فَائِدَةَ}]
\item \textarabic{لَا ـــــــ فِي ذَلِكَ} (no doubt) [\underline{شَكَّ}]
\end{enumerate}
